...
public class HousingLocation {
	...
	public String toString() {
		return "HousingLocation [locationID=" + locationID + ", address1=" + address1 + ", address2=" + address2
				+ ", city=" + city + ", state=" + state + ", zipCode=" + zipCode + ", housingLocationName="
				+ housingLocationName + ", trainingLocation=" + trainingLocation + "]";
	}
