 ...
 * location id in which the object can be grabbed by this id; address1: an address pertaining to
 * that location; address2: a second address which is optional (apt number, building number, etc);
 * city: a city for narrowing down specific locations state: a state for narrowing down specific
 * locations; zipCode: a zipcode for narrowing down specific locations; housingLocationName: housing
 * location name to identify a location with; trainingLocation: a TrainingLocation object in which
